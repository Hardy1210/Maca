  ...
  return (
    <>
      <nav
        className={cn(
          styles.navBar,
          'py-4 md:py-7 px-4 md:px-3 max-w-[87rem] m-auto flex flex-row justify-between items-center gap-10 md:gap-20 lg:gap-56 text-lg text-foreground',
          oswald.className,
          className,
        )}
      >
      ...
      <div
        ...
        className={cn(
          styles.menuBar,
          'z-10 fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center overflow-hidden transition-all duration-300 ease-in-out border-b-4 border-b-neutral-800',
        )}
        style={{ maxHeight: 0 }}
      >
